...
public class Swagger2Config {
    ...
    public Docket createRESTFulApi(@Autowired ApiInfo apiInfo) {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("cn.edu.student.profile.interfaces.web"))
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("zhangzhaoyu", "http://zzy.cincout.cn", "china.zhangzhaoyu@gmail.com"))
                .version("1.0")
                .build();
    }
